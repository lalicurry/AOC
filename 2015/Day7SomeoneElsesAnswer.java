...
public class Day7SomeoneElsesAnswer {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Scanner s = new Scanner(new File("Day7/Day7Input.txt"));
        ...
        System.out.println("Part One: " + vars.get("a").getValue());
        // pre calculated value for part 2
        vars.get("b").setValue(new Literal(vars.get("a").getValue()));

        System.out.println("Part Two: " + vars.get("a").getValue());
    }
